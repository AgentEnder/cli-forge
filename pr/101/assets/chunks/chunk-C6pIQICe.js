import{getEnvironmentProvider as e,getFileSystemProvider as t}from"./chunk-CqmINe_k.js";function n(e){return e.replace(/[^a-zA-Z0-9_]/g,`_`)}function r(e){let t=`_${n(e)}_completions`;return`${t}() {
  local cur_word args
